...
namespace OUBus
{
    public partial class AdminThemChuyen : UserControl
    {
        ...
        {
            AdminThemChuyenData prodData = new AdminThemChuyenData();
            List<AdminThemChuyenData> listData = prodData.productsListData();
